...
func (cc *CategoryCreate) SetCategory(s string) *CategoryCreate {
	cc.mutation.SetCategory(s)
	return cc
}

// SetNillableCategory sets the "category" field if the given value is not nil.
func (cc *CategoryCreate) SetNillableCategory(s *string) *CategoryCreate {
	if s != nil {
		cc.SetCategory(*s)
	}
	return cc
...
func (cc *CategoryCreate) SetSubcategory(s string) *CategoryCreate {
	cc.mutation.SetSubcategory(s)
	return cc
}

// SetNillableSubcategory sets the "subcategory" field if the given value is not nil.
func (cc *CategoryCreate) SetNillableSubcategory(s *string) *CategoryCreate {
	if s != nil {
		cc.SetSubcategory(*s)
	}
	return cc
