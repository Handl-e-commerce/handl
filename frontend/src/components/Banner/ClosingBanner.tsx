...
function ClosingBanner(): JSX.Element {
    ...
    return (
        <Box sx={styles.banner}>
            <Typography variant={'h4'} component={'h4'} fontSize={isMobile ? '28px' : '32px'} mt={2} fontWeight={600} sx={{ alignSelf: 'center'}}>
            ...
            <Box aria-label='steps-and-images-container' sx={{ display: 'flex'}}>
                ...
                <Box aria-label="steps-container" sx={{display: 'flex', flexDirection: 'column', alignItems: 'baseline', mt: 2}}>
                    <Box sx={styles.step}>
                        <Typography variant={'h6'} component={'p'} fontSize={'18px'} sx={{m: 0, mr: 1}}>
                            <span style={{marginRight: '1rem'}}>01</span>
                            <span style={styles.stepText}>Create a Handl account</span>
                        </Typography>
                    </Box>
                    <Box sx={styles.step}>
                        <Typography variant={'h6'} component={'p'} fontSize={'18px'} sx={{m: 0, mr: 1}}>
                            <span style={{marginRight: '1rem'}}>02</span>
                            <span style={styles.stepText}>Upgrade to Premium</span>
                        </Typography>
                    </Box>
                    <Box sx={styles.step}>
                        <Typography variant={'h6'} component={'p'} fontSize={'18px'} sx={{m: 0, mr: 1}}>
                            <span style={{marginRight: '1rem'}}>03</span>
                            <span style={styles.stepText}>Connect with distributors and wholesalers</span>
                        </Typography>
                    </Box>
                </Box>
            </Box>
