...
module.exports = {
  ...
  async up (queryInterface: QueryInterface, Sequelize: typeof DataTypes) {
    ...
    await queryInterface.renameColumn("Users", "publicEIN", "public_ein");
    ...
    await queryInterface.renameColumn("Users", "subscriptionExpiresAt", "subscription_expires_at");
  ...
  async down (queryInterface: QueryInterface, Sequelize: typeof DataTypes) {
    ...
    await queryInterface.renameColumn("Users", "public_ein", "publicEIN");
    ...
    await queryInterface.renameColumn("Users", "subscription_expires_at", "subscriptionExpiresAt");
